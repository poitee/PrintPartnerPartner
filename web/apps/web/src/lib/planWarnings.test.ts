...
describe("planHeaderSubtitle", () => {
  it("joins name, sources, parts", () => {
    const profile = { id: 1, name: "Voron Trident 300", order_number: null, special_request: null, part_count: 359, build_stale: false, archived_at: null, last_used_at: null } satisfies ProfileSummary;
