...
1. **New Build** (header or the **Builds** page) — e.g. `Golden LDO 2.4 SB Tap`.
2. On **Sources**, apply stack preset **LDO 2.4 + Stealthburner + Tap** (`ldo_2.4_sb_tap`) via kit manifest options on the base source.
...
5. Pick STL files, set role colors, **Apply** on **Plan**, and resolve any warnings.

## Export QA bundle

1. On **Sources**, open **Share** and export the plan bundle.
