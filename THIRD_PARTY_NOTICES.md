...
Release builds ship **PySide6**, Python bindings for **Qt**. PySide6 is offered under **LGPL-3.0** (and optionally GPL). Print Partner links against Qt libraries in a bundled onedir layout.

If you distribute a binary build of Print Partner, LGPL obligations may include providing a means to obtain Qt source code and allowing users to relink against modified Qt libraries. See:

- https://www.qt.io/licensing/open-source-lgpl-obligations
- https://doc.qt.io/qt-6/licensing.html

Qt source is available from The Qt Company and project mirrors as described in Qt’s licensing documentation.
